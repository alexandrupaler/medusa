...
if __name__ == '__main__':
    ...
    generate_circuits(min_qubits=4, max_qubits=40, number_of_bench_samples=n_of_circuit_samples, path=config["circuits"], chosen_flags=-1)

    circuit_sizes = range(20, 30 + 1)
    circuit_types = ["b1", "b2", "b3"] #adder
