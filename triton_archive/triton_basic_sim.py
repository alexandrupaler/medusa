...
if __name__ == '__main__':
    ...
    def run_simulation(icm_circuit, flag_circuit, error_mod, error_rate):
        results_flag, results_icm, _, _, acceptance = \
        ...
        return results_flag, results_icm, acceptance
    ...
    def parallel_simulation(inp, n_of_circuit_samples=n_of_circuit_samples):
        ...
        for e in range(len(error_rates)):
            ...
            _, small_icm_failure_rate, _ = run_simulation(small_icm, small_fc, 1, error_rate)

            error_mod = 1.0
            large_fc_failure_rate, large_icm_failure_rate, acceptance = run_simulation(large_icm, large_fc, error_mod, error_rate)
