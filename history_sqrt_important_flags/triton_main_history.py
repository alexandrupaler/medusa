...
if __name__ == '__main__':
    ...
    generate_circuits(min_qubits=4, max_qubits=40, number_of_bench_samples=n_of_circuit_samples, path=config["circuits"],  chosen_flags = -2)
    ...
    for i in range(len(paramlist)):
        ...
        size_small = size_big
        while abs(fc_logical_error - icm_logical_error) > epsilon_target and size_small > 4:
    ...
    plt.title("smallest icm with sqrt(dq) flags")
