...
if __name__ == '__main__':
    ...
    for i in range(0,8):
        ...
        ax1.plot(error_rates, results_icm[i,:] - results_fc[i,:], color=circuit_size_color, label=f"flag adder {i*5+5}")
        
        ax2.plot(error_rates, results_acc[i,:], color=circuit_size_color, label=f"flag adder {i*5+5}")
    ...
    fig2.tight_layout()
    fig2.savefig(f"{plot_file_name_base}_acceptance.png")
