...
if __name__ == '__main__':
    ...
    def parallel_simulation(i):
        ...
        # run simulation   
        results, results_icm = evaluate.stabilizers_benchmark_with_timesteps(flag_circuit, icm_circuit, number_of_runs, error_rates[-1], True, "timesteps_perfect_flags_adder_" + str(i) + ".png", "perfect flags")
