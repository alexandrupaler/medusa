...
if __name__ == '__main__':
    ...
    def parallel_simulation(inp, number_of_samples=n_of_samples):
        ...
        warnings.warn("done " + circuit_type + str(circuit_size))
    ...
    #generate_circuits(min_qubits=4, max_qubits=5, number_of_bench_samples=1, path=config["circuits"])

    circuit_sizes = range(20, 30)
