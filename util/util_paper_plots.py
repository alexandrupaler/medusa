...
if __name__ == '__main__':
    ...
    error_rates = [1*0.01, 3*0.01, 5*0.01, 7*0.01, 10*0.01] 
    ...
    for filename in files:
        ...
        if chosen_circuit_types in str(circuit_type):
            ...
            circuit_type_color = "blue"

            # flag and icm error plotted together
            ax1.scatter(circuit_size_array, fc_res, color='blue')
            ax1.scatter(circuit_size_array, icm_res, color='red')
            ...
            for e in range(len(error_rates)):
                ax3.scatter(int(circuit_size), float(error_mods[e]), color=circuit_type_color )#colors[e])
            ...
            ax3.legend(custom_lines, ['5e-4']) #, '5e-4', '7e-4', '10e-4'])
